...
var largura2 = 303;
var altura2 = 35;
var xCorpo1, xCorpo2, yCorpo1, yCorpo2, rCorpo1, rCorpo2, velocidade1, massa1, velocidade2, massa2; //como colocar a velocidade e massa como movimento em x e massa como raio ??
var xMenu, xMenu2, xMenu3, yMenu1, yMenu2, yMenu3, xMenu4, yMenu4; //entrada p telas do jogo

let img1, img2, img3, educador, programador;
...
function draw() {
  ...
  rect(xMenu, yMenu1, largura, altura, 5, 90);
    if(mouseIsPressed){
      tela = 6; //para tela da memorização antes dos exemplos
    }
}
  fill("black");
  noStroke(0);
  ...
  rect(xMenu2, yMenu2, largura, altura, 5, 90);
    if(mouseIsPressed){
      tela = 3;       //PARA TELA DE INSTRUÇÕES AQUI É A 8 ESSA É ATALHO
    }
  }
  fill("black");
  noStroke(0);
  ...
  else if(tela == 2){       //PERFEITAMENTE INELASTICA
    background("white");
    stroke(20);
  ...
  text("Próxima", 490, 260);
    if(mouseIsPressed){
      tela = 5; //segundo exemplo de colisão
    }
  }
    }
    }
  ...
  else if(tela == 5){      //PARCIALMENTE ELASTICA
    background("white");
    stroke(20);
  ...
  text("Menu", 30, 320);
    ...
    background(img3);
    //imagem da colisão perfeitamente elástica
    stroke(20);
   // image(img3, 20, 20, width, height); //imagem 3 para imagem da colisão
    fill("green");
  noStroke(0);
  text("Próxima", 490, 50);
  fill("black");
  ...
  text("Menu", 30, 320);
    ...
    fill("green")
    noStroke(0);
    text("Agora vamos para    as questões.     Boa sorte !",120, 110, 300, 260);
    textSize(20);
    fill("black");
    noStroke(0);
    text("Menu", 35, 320);
  ...
  text("Próxima", 490, 320);
    ...
    textSize(20);
      noStroke(5);
    fill("black");
      text("1) Se V1i = 2 m/s , V2i = -2 m/s e após a colisão os corpos tiverem velocidades V1f = -3 m/s e V2f = 0,5 m/s , qual o tipo de colisão que ocorreu ?", 20, 20, 520, 260);
  ...
  text("Próxima", 490, 360);
    ...
    if(mouseX > xMenu18 && mouseX < xMenu18 + largura2 && mouseY > yMenu18 && mouseY < yMenu18 + altura2){
      ...
      text("A-) Inelástica.", -186, 120, 520, 260);
      if(mouseIsPressed){
        tela = 12;    ///TO AQUI CARALHO VAI TOMAR NO CU
      }
    }
    ...
    text("B-) Parcialmente elástica.", -132, 160, 520, 260);
    if(mouseIsPressed){
      tela = 12;     ///TO AQUI CARALHO VAI TOMAR NO C
    }
  }
  ...
  text("Próxima", 490, 300);
    ...
    if(mouseX > xMenu22 && mouseX < xMenu22 + largura2 && mouseY > yMenu22 && mouseY < yMenu22 + altura2){
      ...
      text("A-) Inelástica.", -186, 120, 520, 260);
      if(mouseIsPressed){
        tela = 13;    ///TO AQUI CARALHO VAI TOMAR NO CU
      }
    }
    ...
    text("B-) Parcialmente elástica.", -132, 160, 520, 260);
    if(mouseIsPressed){
      tela = 13;     ///TO AQUI CARALHO VAI TOMAR NO C
    }
  }
    ...
    text("B-) Parcialmente elástica.", -132, 160, 520, 260);
    if(mouseIsPressed){
      tela = 14;     ///TO AQUI CARALHO VAI TOMAR NO C
    }
  }
    if(mouseX > xMenu24 && mouseX < xMenu24 + largura2 && mouseY > yMenu24 && mouseY < yMenu24 + altura2){
      stroke(90);
   ...
   text("Gabarito:", 50, 40);
    ...
    }                      if(mouseX>xMenu17&&mouseX<xMenu17+largura&&mouseY>yMenu17&&mouseY<yMenu17+altura){
      stroke(90);
      fill("white");
      rect(xMenu17, yMenu17, largura, altura, 5, 90);
      fill("red");
      noStroke(0);
      text("Questão Desafio", 90, 400);
      if(mouseIsPressed){
